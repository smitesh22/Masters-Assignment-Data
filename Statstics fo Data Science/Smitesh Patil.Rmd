...
A histogram is given below. I would describe the shape of the distribution using the histogram as right skewed. Although number of data points in the dataset are less to make any conclusion on the shape of histogram.
