...
```
2. Implement the bar plot using the ggplot2 library[1]
...
[1]Note: for the dot-plot, I was having last minute issues trying to order the food CPI values. 
Hence,I tried for help on stack overflow, Here is the link of the question I asked:
https://stackoverflow.com/questions/75440844/ordering-of-ggplot-not-working-with-factors.
I thought, I'd let you know beforehand.
